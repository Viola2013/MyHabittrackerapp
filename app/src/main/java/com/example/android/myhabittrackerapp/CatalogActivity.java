...
public class CatalogActivity extends AppCompatActivity {
    ...
    private void displayDatabaseInfo() {
        ...
        try {
            ...
            int nameColumnIndex = cursor.getColumnIndex(HabitEntry.COLUMN_USER_NAME);
            int distanceColumnIndex = cursor.getColumnIndex(HabitEntry.COLUMN_DISTANCE);
            int stepsColumnIndex = cursor.getColumnIndex(HabitEntry.COLUMN_STEPS);
    ...
    /**
     * Helper method to insert hardcoded user data into the database. For debugging purposes only.
     */
    private void insertHabit() {
        ...
        // and dummy user attributes are the values.
        ContentValues values = new ContentValues();
        values.put(HabitEntry.COLUMN_USER_NAME, "Mervi");
        values.put(HabitEntry.COLUMN_DISTANCE, "2 KM");
        values.put(HabitEntry.COLUMN_STEPS, 2000);

        // Insert a new row for dummy user in the database, returning the ID of that new row.
